...
try:
    ...
    print("The file names.txt file was not found. Check the path variable and filename.")
    exit(1)
except IOError:
...
with open(filename, 'w') as f:
    ...
    if not_assigned:
        print(f"The following names didn't make it onto the schedule: {', '.join(not_assigned)}")
    else:
